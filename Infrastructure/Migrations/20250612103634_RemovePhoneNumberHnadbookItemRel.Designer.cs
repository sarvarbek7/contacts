...
namespace Contacts.Infrastructure.Migrations
{
    ...
    [Migration("20250612103634_RemovePhoneNumberHnadbookItemRel")]
    partial class RemovePhoneNumberHnadbookItemRel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PhoneNumber", b =>
                {
                    ...
                    b.Property<int?>("ActiveAssignedOrganizationId")
                        .HasColumnType("integer")
                        .HasColumnName("active_assigned_organization_id");

                    b.Property<int?>("ActiveAssignedPositionId")
                        .HasColumnType("integer")
                        .HasColumnName("active_assigned_position_id");

                    b.Property<int?>("ActiveAssignedPositionUserId")
                        .HasColumnType("integer")
                        .HasColumnName("active_assigned_position_user_id");
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PositionPhoneNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_position_phone_number");

                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_position_phone_number_created_by_id");

                    b.HasIndex("PhoneNumberId")
                        .HasDatabaseName("ix_position_phone_number_phone_number_id");

                    b.HasIndex("RemovedById")
                        .HasDatabaseName("ix_position_phone_number_removed_by_id");

                    b.ToTable("position_phone_number", (string)null);
                });

            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PositionUserPhoneNumber", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_position_user_phone_number");

                    b.HasIndex("CreatedById")
                        .HasDatabaseName("ix_position_user_phone_number_created_by_id");

                    b.HasIndex("PhoneNumberId")
                        .HasDatabaseName("ix_position_user_phone_number_phone_number_id");

                    b.HasIndex("RemovedById")
                        .HasDatabaseName("ix_position_user_phone_number_removed_by_id");

                    b.ToTable("position_user_phone_number", (string)null);
                });
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.UserPhoneNumber", b =>
                {
                    ...
                    b.HasIndex("RemovedById")
                        .HasDatabaseName("ix_user_phone_number_removed_by_id");
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PhoneNumber", b =>
                {
                    b.HasOne("Contacts.Domain.Users.User", "ActiveAssignedPositionUser")
                        .WithMany("ActivePhonePositionNumbers")
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PositionPhoneNumber", b =>
                {
                    b.HasOne("Contacts.Domain.Accounts.Account", "CreatedBy")
                        ...
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_position_phone_number_account_created_by_id");
                    ...
                    b.HasOne("Contacts.Domain.PhoneNumbers.PhoneNumber", "PhoneNumber")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_phone_number_phone_number_phone_number_id");

                    b.HasOne("Contacts.Domain.Accounts.Account", "RemovedBy")
                        .WithMany()
                        .HasForeignKey("RemovedById")
                        .HasConstraintName("fk_position_phone_number_account_removed_by_id");
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PositionUserPhoneNumber", b =>
                {
                    b.HasOne("Contacts.Domain.Accounts.Account", "CreatedBy")
                        ...
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_position_user_phone_number_account_created_by_id");

                    b.HasOne("Contacts.Domain.PhoneNumbers.PhoneNumber", "PhoneNumber")
                        .WithMany("PositionUsersHistory")
                        .HasForeignKey("PhoneNumberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_user_phone_number_phone_number_phone_number_id");

                    b.HasOne("Contacts.Domain.Accounts.Account", "RemovedBy")
                        .WithMany()
                        .HasForeignKey("RemovedById")
                        .HasConstraintName("fk_position_user_phone_number_account_removed_by_id");
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.UserPhoneNumber", b =>
                {
                    ...
                    b.HasOne("Contacts.Domain.Accounts.Account", "RemovedBy")
                        .WithMany()
                        .HasForeignKey("RemovedById")
                        .HasConstraintName("fk_user_phone_number_account_removed_by_id");

                    b.HasOne("Contacts.Domain.Users.User", "User")
                        .WithMany("PhoneNumberHistory")
            ...
            modelBuilder.Entity("Contacts.Domain.PhoneNumbers.PhoneNumber", b =>
                {
                    ...
                    b.Navigation("PositionUsersHistory");
            ...
            modelBuilder.Entity("Contacts.Domain.Users.User", b =>
                {
                    b.Navigation("ActivePhoneNumbers");

                    b.Navigation("ActivePhonePositionNumbers");

                    b.Navigation("PhoneNumberHistory");
                });
